    ...
    return (
        <div className="relative flex w-full flex-col items-center justify-center overflow-hidden bg-transparent p-10 py-10 ">
            ...
            <div className='flex flex-col gap-4'>
                <h1 className='text-8xl font-black md:text-9xl uppercase z-30 mt-20 text-center'>Win <span className="bg-gradient-to-r from-[#050deb] to-[#ff00e2] text-transparent bg-clip-text">€100!</span></h1>
                            ...
                            <div key={label} className='flex flex-col items-center'>
                                <div className='flex items-center'>
                                    <div className='w-[80px]  sm:w-[120px] md:w-[200px] h-[80px] sm:h-[120px] md:h-[200px] flex items-center justify-center text-[30px] sm:text-[50px] md:text-[100px] font-semibold'>
                                        <span className="font-extralight bg-gradient-to-r from-[#050deb] to-[#ff00e2] text-transparent bg-clip-text">{value}</span>
                                    </div>
